...
public enum Equipment {
    ...
    EPEE_COURTE(
            ...
            Category.ARME, Source.ARMURERIE, ApplyMode.PASSIVE,  75,
            2, 0, 0, 0),

    EPEE_LONGUE(
            "Épée longue",
            "Arme puissante à une main. Réservée au Barbare et au Nain.",
            Category.ARME, Source.ARMURERIE, ApplyMode.PASSIVE, 150,
            3, 0, 0, 0),
    ...
    HACHE_DE_BATAILLE(
            ...
            Category.ARME, Source.ARMURERIE, ApplyMode.PASSIVE,175,
            3, 0, 0, 0),
    ...
    BOUCLIER(
            ...
            Category.ARMURE, Source.ARMURERIE, ApplyMode.PASSIVE,50,
            0, 1, 0, 0),

    CASQUE(
            "Casque",
            "Protège la tête. Compatible avec toutes les armures.",
            Category.ARMURE, Source.ARMURERIE, ApplyMode.PASSIVE,125,
            0, 1, 0, 0),

    COTTE_DE_MAILLES(
            "Cotte de mailles",
            "Armure intermédiaire. Portée par le Barbare et le Nain.",
            Category.ARMURE, Source.ARMURERIE, ApplyMode.PASSIVE,150,
            0, 2, 0, 0),

    ARMURE_DE_PLATES(
            "Armure de plates",
            "Armure complète. Très lourde : interdit de courir.",
            Category.ARMURE, Source.ARMURERIE, ApplyMode.PASSIVE,350,
            0, 3, 0, 0),
    ...
    POTION_DE_GUERISON(
            ...
            Category.POTION, Source.ARMURERIE, ApplyMode.ACTIVE,150,
            0, 0, 4, 0),

    EAU_BENITE(
            "Eau bénite",
            "Restaure 2 points d'esprit. Usage unique.",
            Category.POTION, Source.ARMURERIE, ApplyMode.ACTIVE,75,
            0, 0, 0, 2),
    ...
    POTION_DE_DEFENSE(
            ...
            Category.POTION, Source.ARMURERIE, ApplyMode.ACTIVE,100,
            0, 2, 0, 0),
    ...
    HACHE_NAINE(
            ...
            Category.ARME, Source.RECOMPENSE_QUETE, ApplyMode.PASSIVE, 0,
            3, 0, 0, 0),

    ARMURE_SIR_RAGNAR(
            "Armure de Sir Ragnar",
            "Récompense Q05 — Le Sauvetage de Sir Ragnar. Armure de chevalier.",
            Category.ARMURE, Source.RECOMPENSE_QUETE,  ApplyMode.PASSIVE,0,
            0, 2, 0, 0),
    ...
    SORT_DE_GUERISON(
            ...
            Category.SORT, Source.RECOMPENSE_QUETE,  ApplyMode.PASSIVE,0,
            0, 0, 4, 0),
    ...
    SORT_BOULE_DE_FEU(
            ...
            Category.SORT, Source.RECOMPENSE_QUETE,  ApplyMode.ACTIVE,0,
            3, 0, 0, 0),
    ...
    AMULETTE_DE_RESISTANCE(
            ...
            Category.AMULETTE, Source.RECOMPENSE_QUETE,  ApplyMode.PASSIVE,0,
            0, 0, 0, 0),
    ...
    public enum ApplyMode   { ACTIVE, PASSIVE }
